...
?
- You aim to show that a statement leads to a tautology and thus is true.
<!--SR:!2025-02-02,4,287-->
...
?
The characteristic function (also called the indicator function) of a set $A$ is a function that indicates membership in $A$. It is defined as:$$\chi A(x)=\begin{cases} 1, & \text{if } x \in A \\ 0, & \text{if } x \notin A \end{cases}$$
<!--SR:!2025-02-02,4,291-->
...
**How do we denote a function $f$, that takes arguments from $A$ and $B$ and returns from $C$?**
?
...
- An **irreflexive** relation is one where no element is related to itself.
- A **symmetric** relation is one where if an element $a$ is related to an element $b$, then $b$ is also related to $a$.
- An **asymmetric** relation is one where if $a$ is related to $b$, then $b$ is not related to $a$.
- An **antisymmetric** relation is one where if $a$ and $b$ are related, and $b$ and $a$ are also related, then $a$ and $b$ must be the same element.
- A **transitive** relation is one where if $a$ is related to $b$, and $b$ is related to $c$, then $a$ is also related to $c$.
<!--SR:!2025-02-02,4,298-->
...
<!--SR:!2025-02-02,4,294!2025-02-02,4,294!2025-02-02,4,298-->
...
<!--SR:!2025-02-01,3,274!2025-02-03,4,278!2025-02-02,4,295-->
...
- **Arrow ($\Rightarrow$)**: ==Denotes "evaluates to" or "transforms to" (notation is context-depende==nt).
<!--SR:!2025-02-02,4,284-->
...
<!--SR:!2025-02-02,4,289!2025-02-02,4,289-->
